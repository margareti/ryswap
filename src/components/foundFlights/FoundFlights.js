...
class FoundFlights extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <form>
          <div className="found-flights__title">
            {firstFlight.origin.airportName} => {firstFlight.destination.airportName} on{' '}
            {moment(firstFlight.datetime).format('dddd DD/MM/YY')}
          </div>
